...
# ╔═╡ e344d08e-007e-11ec-08a7-c964a27de66a
using Flux, PlutoUI, Plots, Pkg

# ╔═╡ df3f1306-e47f-4aee-94e1-da229d269a69
VERSION

# ╔═╡ 8c7b821c-02e0-4194-a6ff-bbf2bebdae1d
with_terminal() do 
	Pkg.status()
end

# ╔═╡ ecd249c5-51ab-4dab-a3aa-992d745a569d
md"""
## Building layers
References: 
- https://fluxml.ai/Flux.jl/stable/models/basics/#Building-Layers

"""

# ╔═╡ 155264b6-74b4-40dd-bc4b-731e82782181
begin 
	W1 = rand(3, 5) # 3 by 5 random matrix 
	b1 = rand(3)     # 3 vector 
	layer1(x) = W1 * x .+ b1 # input x is multipled by weights W1 and then added to b1.
	W2 = rand(2, 3) 
	b2 = rand(2)
	layer2(x) = W2 * x .+ b2
	model(x) = layer2(σ.(layer1(x))) #σ is sigmoid function
	model(rand(5))
end

# ╔═╡ 26b0482b-7759-4197-a24e-8ec933139fcb
md"""
But this is fairly unwieldy.
This requres lots of repetitions, e.g. we need to define each layer. 
"""

# ╔═╡ 32493dbd-1f31-4d5b-a01f-99bd7a5aa396
md"""
## Define a function for the avoidance of repetition. 
To avoid this, we can define a function, `linear(in, out)`, that takes the number of elements of an input vector and of the elements of an output vector.
"""

# ╔═╡ cbb2ca97-f925-4c69-8de5-dc7fe91affcb
begin
...
# ╔═╡ baeb845e-8bac-425f-9507-1716067ad243
md"""
## Another equivalent way: Define Affine type
Actually, this implementation is almost equivalent to `Flux.Dense()`.
"""

# ╔═╡ 92b275e7-ff1d-40d3-a695-91ac9d022c7a
begin 
	struct Affine
		W
		b
	...
	# Constructer of Affine struct. Once in and out are given, Affine type is initialized by randn.
...
# ╔═╡ 10311571-5340-42f2-8fca-151cb4d4bee7
md"""
# How to stack up layers
"""

# ╔═╡ 4e809538-0bd1-40bd-977d-580f71eabc2a
md"## A straightforward way."

# ╔═╡ 6cac3a51-4500-46c7-b88b-5da292829331
#layer1 = Dense(10, 5, σ) 
#...
#model(x) = layer3(layer2(layer1(x)))

# ╔═╡ 04872601-1f5b-4ee9-bfc7-42c225b883c2
md"## List way"

# ╔═╡ 35a3e4f8-c868-4452-8149-80bd5a4be26c
begin
...
# ╔═╡ f45898f5-25d9-4cb1-8a91-52f6aed82e11
md"## Handy way"

# ╔═╡ bf988945-2432-4b47-8431-e7781c478dcd
begin
	model4 = Chain(Dense(10, 5, σ), Dense(5, 2), softmax)
	model4(rand(10))
end

# ╔═╡ 7edd20bc-b50d-415d-8762-f47e4d86563a
md"## Function composition"

# ╔═╡ fe97929c-8a03-4530-94b2-65f73eefa1ac
begin
	m = Dense(5, 2) ∘ Dense(10, 5, σ) #\circ tab
	m(rand(10))
end
